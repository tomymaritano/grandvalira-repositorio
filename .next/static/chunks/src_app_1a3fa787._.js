...
"[project]/src/app/validation/auth.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$validation$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/validation/auth.ts [app-client] (ecmascript)");
...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setIsLoading(true);
        setError('');
        const result = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$validation$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loginSchema"].safeParse({
            email,
            password
        });
        if (!result.success) {
...
_s(LoginPage, "QZGlptQZppl3pfhQN4SI8QI0cdo=", false, function() {
    return [
...
//# sourceMappingURL=src_app_1a3fa787._.js.map